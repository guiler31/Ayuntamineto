...
public class ModeloBBDD implements Modelo {
	...
	public void Consulta2(String documentoIdentidad) {
		vista.clear_Table();
		String query = "";

		try {
			if (documentoIdentidad == null || documentoIdentidad.equals("")) {
				query = "SELECT * FROM actividad join relintrep on actividad.idIntRep = relintrep.id JOIN interesado on relintrep.idInteresado = interesado.id  where interesado.cif = ?";

			}
			PreparedStatement pstmt = conexion.prepareStatement(query);
			pstmt.setString(1, documentoIdentidad);
			int cont = 0;
	...
	public void Consulta3(String tipo) {
